##########################################################
## OLSEN TEAM ROX THE HIZZOUSE				##
##########################################################

## USAGE NOTES: 					##
## 	you should run this script with a	 	##
##	command like:				 	##
...
###################################################
## VARIABLES: change this stuff			 ##
###################################################

	#original pdb
	set pdbfile "1A6M.pdb" 
	#output name
	set outputname mb_native_noles
	#topology file
...
if { $opatch } {
	append outputname "_patch"
} else {
	append outputname "_nopatch"
}
